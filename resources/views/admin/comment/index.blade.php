                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <a href="{{route('admin.comment.add')}}" class="addtop"><img src="/public/templates/admin/assets/img/add.png" alt="" /> Thêm</a>
                            </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                            ...
                                            $urlEdit=route('admin.comment.edit',[$page,$id]);
                                            $urlDel=route('admin.comment.del',[$page,$id]);
                                        @endphp
                                        <tr>
                                            <td>{{$id}}</td>
